  ...
  render(): JSX.Element {
    return (
      <View style={this.props.containerStyle}>
        <SearchBar
          onChangeText={text =>
            this.props.handleSearch(text, this.props.locationIndex)
          }
          ...
          containerStyle={[
            styles.searchBar,
            this.props.isLastSearchBar === true ? styles.lastSearchBar : '',
          ]}
          inputContainerStyle={styles.searchBarContainerInput}
          inputStyle={styles.searchBarInput}
          placeholderTextColor={
            this.props.isGPSUsed === true ? palette.orangeLight : '#86939e'
          }
          searchIcon={
