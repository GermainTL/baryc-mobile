    ...
    async openLocation(serviceName) {
        ...
        try {
            ...
            await showLocation({
                ...
                sourceLatitude: (userLocation != null) ? userLocation.coords.latitude : null,
                sourceLongitude: (userLocation != null) ? userLocation.coords.longitude : null,
                app: serviceName,
                directionsMode: 'walk'
            })
        }
                                ...
                                this.state.bar.specificites.map(specificity => {
                                        return (
                                            <View key={ specificity } style={ styles.mainAssetsContainer }>
                                                <Image source={barAssetsConstants[specificity]} style={ styles.mainAssetImg }/>
